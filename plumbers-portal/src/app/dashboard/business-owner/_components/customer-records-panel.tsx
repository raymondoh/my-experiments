...
export function CustomerRecordsPanel({ customers, onCreateCustomer, onUpdateCustomer, onRecordInteraction, onDeleteCustomer }: CustomerRecordsPanelProps) {
                  ...
                  <div key={customer.id} className="rounded-lg border border-border p-4">
                    <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Last service: {formatDate(customer.lastServiceDate)} · Jobs completed: {customer.totalJobs} · Lifetime spend: £
                    ...
                    <div className="mt-4 grid gap-3 md:grid-cols-4">
                      <Textarea
                        ...
                        onChange={event =>
                          setInteractionNotes(prev => ({ ...prev, [customer.id]: event.target.value }))
                        }
                      ...
                      <div className="grid gap-2 md:grid-cols-2">
                        <Input
                          ...
                          onChange={event =>
                            setInteractionJobs(prev => ({ ...prev, [customer.id]: event.target.value }))
                          }
                        />
                        <Input
                          type="number"
                      ...
                      <div className="md:col-span-4 flex justify-end">
                        <Button
                          type="button"
                          onClick={() => handleRecordInteraction(customer)}
                          disabled={isPending}
                        >
                          Log interaction
                        </Button>
