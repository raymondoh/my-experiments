...
export function InventoryManagementPanel({ items, onCreateItem, onUpdateItem, onAdjustQuantity, onDeleteItem }: InventoryManagementPanelProps) {
  ...
  const handleAdjust = (itemId: string, delta: number) => {
    handleServerAction(onAdjustQuantity as ServerAction<{ itemId: string; delta: number }>, { itemId, delta }, "Inventory updated");
  };
