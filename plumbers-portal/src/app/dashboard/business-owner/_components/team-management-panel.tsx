...
type TeamManagementPanelProps = {
  members: TeamMember[];
  onCreateMember: typeof createTeamMemberAction;
  onUpdateMember: typeof updateTeamMemberAction;
  onAssignJob: typeof assignJobToMemberAction;
  onDeleteMember: typeof deleteTeamMemberAction;
};

export function TeamManagementPanel({ members, onCreateMember, onUpdateMember, onAssignJob, onDeleteMember }: TeamManagementPanelProps) {
  ...
  const handleAssign = (memberId: string) => {
    ...
    handleServerAction(onAssignJob as ServerAction<{ memberId: string; jobId: string }>, { memberId, jobId }, "Job assigned", () => {
                    ...
                    <TableCell className="space-y-2">
                      <div className="flex gap-2">
                        <Input
                          ...
                          onChange={event =>
                            setAssignments(prev => ({ ...prev, [member.id]: event.target.value }))
                          }
                        />
                        <Button
                          type="button"
