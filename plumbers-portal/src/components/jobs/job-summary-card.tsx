...
export function JobSummaryCard({ job, tier, actions }: JobSummaryCardProps) {
  const isProTier = tier === "pro" || tier === "business";

  // --- THIS IS THE FIX ---
  // Define which payment statuses mean the deposit has been paid
      ...
      <CardHeader className="bg-muted/50">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {/* --- THIS IS THE FIX --- */}
            {/* Conditionally render the "Deposit Paid" badge for the tradesperson */}
            {hasDepositBeenPaid && (
