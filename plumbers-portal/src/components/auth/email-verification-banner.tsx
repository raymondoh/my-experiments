      ...
      <CardContent className="p-4">
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <h3 className="font-medium text-foreground">Email Verification Required</h3>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 mt-4">
              <Button size="sm" variant="outline" onClick={handleResend} disabled={isResending || resendSuccess}>
