...
export async function storeVerificationToken(email: string, token: string, expiresAt: Date): Promise<void> {
  try {
    ...
    console.error("UserService: storeVerificationToken error:", error);
...
export async function storePasswordResetToken(email: string, token: string, expiresAt: Date): Promise<void> {
  try {
    ...
    console.error("UserService: storePasswordResetToken error:", error);
...
export async function verifyAndConsumeToken(
  ...
  try {
    ...
    console.error("UserService: verifyAndConsumeToken error:", error);
    return null;
  }
}
...
export async function verifyTokenWithoutConsuming(
  ...
  try {
    ...
    console.error("UserService: verifyTokenWithoutConsuming error:", error);
    return null;
  }
}
