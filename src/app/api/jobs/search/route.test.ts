...
describe("job search route", () => {
  ...
  it("filters parameters and returns sorted jobs", async () => {
    ...
    const res = await fetch(
      "http://localhost/api/jobs/search?q=leak&urgency=emergency&serviceType=Repair&location=LS1&radius=10&minBudget=100&maxBudget=500&noQuotes=true&datePosted=7&page=2&limit=5"
    );
